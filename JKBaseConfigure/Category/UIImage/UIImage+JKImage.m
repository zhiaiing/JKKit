...
- (UIImage *)jk_flipVertical{
    return [self jk_rotate:UIImageOrientationDownMirrored];
}
...
- (UIImage *)jk_flipHorizontal{
    return [self jk_rotate:UIImageOrientationUpMirrored];
}
...
- (UIImage *)jk_imageRotatedByDegrees:(CGFloat)degrees{
    return [self jk_imageRotatedByRadians:kDegreesToRadian(degrees)];
}
...
- (UIImage *)jk_rescaleImageToPX:(CGFloat )toPX{
    ...
    return [self jk_rescaleImageToSize:size];
}
