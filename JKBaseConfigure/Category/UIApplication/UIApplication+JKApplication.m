...
- (NSString *)jk_appBundleName {
    return [[NSBundle mainBundle] objectForInfoDictionaryKey:@"CFBundleName"];
}

- (NSString *)jk_appBundleID {
...
- (NSString *)jk_appBuildVersion {
    return [[NSBundle mainBundle] objectForInfoDictionaryKey:@"CFBundleVersion"];
}

- (int64_t)jk_memoryUsage {
...
- (BOOL)jk_isPirated {
    if ([[UIDevice currentDevice] jk_isSimulator]) return NO; // Dont't check simulator
