...
- (void)safeSetObject:(id)obj atIndexedSubscript:(NSUInteger)idx {
    NSAssert(obj, @"setObject:atIndexedSubscript: 异常，obj为空，请修复");
    if (obj == nil) {
        return;
    }
    
    if (self.count < idx) {
        NSAssert(obj, @"setObject:atIndexedSubscript: 异常，index越界，请修复");
        return;
    }
...
- (void)safeSetObject:(id)obj forKeyedSubscript:(id <NSCopying>)key {
    NSAssert(key, @"setObject:forKeyedSubscript: 异常，请修复");
    if (!key) {
        return;
    }
